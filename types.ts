...
export type ThemeId = 'light' | 'dark' | 'soft' | 'cyberpunk' | 'minimalist';
...
export interface GameState {
  type: 'none' | 'tictactoe' | 'memory' | 'gomoku' | 'rps';
  ...
  sessionScores?: Record<string, number>; // Persists between rounds
}
